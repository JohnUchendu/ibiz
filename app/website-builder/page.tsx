  ...
  const plans = [
    {
      ...
      cta: "https://paystack.com/pay/PAYSTACK_LINK_STARTER",
      tag: "Most affordable",
    },
    {
      id: "growth",
      ...
      cta: "https://paystack.com/pay/PAYSTACK_LINK_GROWTH",
    ...
    },
    {
      ...
      cta: "https://paystack.com/pay/PAYSTACK_LINK_PREMIUM",
  ...
  return (
    <section className="max-w-7xl mx-auto px-6 py-12">
            ...
            >
              ...
              <div className="mt-auto">
                ...
                <p className="text-xs mt-3 text-slate-500">
                  Replace the PAYSTACK link placeholder with your Paystack
      ...
      <div className="mt-8 text-sm text-slate-500">
        <strong>How to use:</strong> Import this component into your page.tsx
        and drop it where you'd like the pricing section to appear. Replace the
        `https://paystack.com/pay/PAYSTACK_LINK_*` URLs with the actual Paystack
        hosted payment link for each plan.
      </div>
      {/* Contact */}
